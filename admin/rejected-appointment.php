...
<html>
<head>
<title>ระบบจัดการจองบริการ || ยกเลิกการจอง</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">ยกเลิกการจอง</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						<h4>ยกเลิกการจอง:</h4>
						<table class="table table-bordered"> <thead> <tr> <th>#</th> <th> หมายเลขการจอง</th> <th>ชื่อ</th><th>เบอร์ติดต่อ</th> <th>วันที่จอง</th><th>เวลาจอง</th><th>Action</th> </tr> </thead> <tbody>
<?php
