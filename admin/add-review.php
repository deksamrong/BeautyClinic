...
if($upload !='') {
	...
	$sql = "insert into  tblreview(reviewname,uplaodfile) values('$name','$newname')";
    $query=mysqli_query($con, $sql) or die ("Error in query: $sql " . mysqli_error());;
    if ($query) {
    	echo "<script>alert('เพิ่มริวิวสำเร็จ.');</script>"; 
...
<body class="cbp-spmenu-push">
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">เพิ่มรีวิวลูกค้า</h3>
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">รีวิว</label> <input type="text" class="form-control" id="reviewname" name="reviewname"  value="" required="true"> </div> 
